# Assignment-2-SoftwareEngineering-Lab-RobeeHerrera
...
2. Each device has unique actions associated with these commands. For example, turning on the lights might involve changing their brightness level, while turning on the music player may
   involve playing a specific playlist.
...
#  UML Class Diagram
![image](https://github.com/user-attachments/assets/63d4fe26-4bd2-4065-84fd-f7819bf683dd)
